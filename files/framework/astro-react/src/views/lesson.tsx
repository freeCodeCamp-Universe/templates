...
import { ListeningChoice } from '../components/tasks/listening-choice';
import { WordBuilder } from '../components/tasks/word-builder';
      ...
      <div className="lesson-content">
        <section>
          ...
          {lesson.content.map((block, index) => {
            ...
            if (block.task.type === 'listening-choice') {
              return <ListeningChoice key={index} task={block.task} onCorrect={handleTaskPassed} />;
            }

            if (block.task.type === 'word-builder') {
              return <WordBuilder key={index} task={block.task} onCorrect={handleTaskPassed} />;
            }
